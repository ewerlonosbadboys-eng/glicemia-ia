...
# --- ABA 3: AJUSTES COM TRAVA DE 11H + 10 MINUTOS ---
with aba3:
        ...
        if st.button("💾 Aplicar e Corrigir Descansos"):
            ...
            for i in range(idx + 1, 31):
                if df_e.loc[i-1, 'Status'] == 'Trabalho':
                    ...
                    # ADICIONADO: 11 horas + 10 minutos de intervalo
                    ...
                    if minimo > base:
                        ...
                        df_e.loc[i, 'H_Saida'] = (datetime.combine(datetime.today(), base) + timedelta(hours=9, minutes=58)).strftime("%H:%M")

            st.session_state['historico'][f_edit] = df_e
            st.success("Horário e descansos (11h 10m) atualizados!")
